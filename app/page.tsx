...
const useCases: UseCaseItem[] = [
  ...
  },
  {
    ...
    visual: 'uc-bag',
    title: '백 참 스타일링',
    desc: '끝이 자연스럽게 흔들리며 가방에 리듬을 더해줍니다',
  },
  {
    id: 'wrist',
    number: '04',
...
const philosophyItems: PhilosophyItem[] = [
  {
    ...
    number: '01',
    title: '가볍게 더하다',
    desc: '티셔츠 하나에 묶는 것만으로 전혀 달라지는 분위기. 거창하지 않아도 좋습니다.',
  },
  {
    id: 'move',
    number: '02',
    title: '움직임에서 살아나다',
    desc: '걷고, 춤추고, 움직일 때 더 빛나는 디자인. 정지된 사진보다 살아있는 순간에 어울립니다.',
  },
  {
    id: 'way',
    number: '03',
    title: '방식에 따라 달라진다',
    desc: '같은 천이라도 묶는 방법에 따라 전혀 다른 무드가 됩니다. 정해진 정답은 없습니다.',
  },
  {
    id: 'material',
    number: '04',
    title: '소재가 말하게 한다',
    desc: '과하지 않은 프린트, 손에 닿는 질감, 색이 전달하는 무드. 디자인보다 소재가 먼저입니다.',
  },
]
...
const faqItems: FaqItem[] = [
  {
    ...
    answer:
      '캐주얼부터 스트릿, 레이어드 룩까지 다양하게 어울립니다. 특정 스타일을 타지 않고, 오히려 포인트 하나로 전체 무드를 바꿔주는 아이템입니다.',
  },
  {
    id: 'gender',
    question: '남녀 공용인가요?',
    answer:
      '네, 젠더리스로 디자인되었습니다. 사이즈나 컷이 아닌 묶는 방식으로 연출하는 아이템이라 누구에게나 잘 어울립니다.',
  },
  {
    id: 'launch',
    question: '언제 출시되나요?',
    answer:
      '현재 준비 중입니다. 출시 소식은 인스타그램을 통해 가장 먼저 공유드릴 예정입니다. 팔로우해두시면 놓치지 않으실 수 있습니다.',
  },
  {
    id: 'material',
    question: '어떤 소재인가요?',
    answer:
      '테누구이 특유의 얇고 가벼운 면 소재를 기반으로 합니다. 부드럽게 늘어지면서도 묶었을 때 형태가 잘 잡히는 것이 특징입니다.',
  },
  {
    id: 'purchase',
    question: '어디서 구매할 수 있나요?',
    answer:
      '아직 정식 출시 전입니다. 관심 있으신 분들은 인스타그램 팔로우 또는 메일로 문의 주시면 출시 알림을 드리겠습니다.',
  },
]
        ...
        <div className="container scroll-reveal">
          <div className="concept-inner">
            ...
            <div className="concept-body">
              ...
              <p>
                목에 가볍게 두르거나, 머리에 묶거나, 가방에 매달거나. 하나의 천이 만드는 분위기는
                묶는 방식에 따라 전혀 달라집니다. 단순한 천 제품이 아니라, 무드와 스타일링을 담은
                브랜드입니다.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="use-cases-grid">
            {useCases.map((item, i) => (
              <article
                key={item.id}
                className={`use-case-card scroll-reveal scroll-reveal-d${(i % 4) + 1}`}
              >
        ...
        <div className="container">
          ...
          <div className="lookbook-grid">
            {lookbookItems.map((item, i) => (
              <div
                key={item.id}
                className={`lookbook-card ${item.visual} scroll-reveal scroll-reveal-d${i + 1}`}
              >
        ...
        <div className="container">
          ...
          <div className="philosophy-grid">
            {philosophyItems.map((item, i) => (
              <div
                key={item.id}
                className={`philosophy-item scroll-reveal scroll-reveal-d${(i % 4) + 1}`}
              >
      ...
      <footer className="footer" aria-label="푸터">
        <div className="container">
          ...
          <nav className="footer-links" aria-label="소셜 및 문의">
            <span className="footer-link footer-link-disabled" aria-label="인스타그램 준비중">
              Instagram
            </span>
            <span className="footer-sep" aria-hidden="true" />
            <a href="mailto:hello@kasane.kr" className="footer-link" aria-label="문의 메일 보내기">
              Contact
            </a>
          </nav>
